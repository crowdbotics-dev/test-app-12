"""
Django settings for test_app_12 project.
...
WSGI_APPLICATION = 'test_app_12.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_app_12 API",
    "DESCRIPTION": "API documentation for test_app_12 App",
    "VERSION": "v1",
}
